    ...
    <div class="card">
        ...
        <div class="card-footer">
            ...
            <form method="POST"
                ...
                <div id="cash-payment-fields" class="mb-2 d-none">
                    <label for="uang_dibayar" class="form-label">Uang Dibayar</label>
                    <input type="number" name="uang_dibayar" id="uang_dibayar"
                        class="form-control" min="{{ $sale->total_pembayaran }}"
                        value="{{ old('uang_dibayar') }}" placeholder="Masukkan nominal uang">
                    <div class="mt-2">
...
<script>
    ...
    function updateCashPayment() {
        ...
        changeAmount.textContent = 'Rp ' + Math.max(0, paid - total).toLocaleString('id-ID');
    }

    paymentMethod.addEventListener('change', updateCashPayment);
    paidInput.addEventListener('input', updateCashPayment);
    updateCashPayment();
</script>
@endsection